...
# ["click", x, y]            → 手动点击坐标
ACTIONS = [
    # ["find_text", "免费"],   # 自动找屏幕上的 guanggao.png 并点击
    ["find", "static/images/mianfeipower.png"],   # 自动找屏幕上的 mainpower.png 并点击
    ["wait", 32],
    ["find", "static/images/closed.png"],   # 自动找屏幕上的 closed.png 并点击
    ["wait", 1],    
    ["find", "static/images/mianfeipower.png"], 
...
def post_icon_action():
    find_and_click("static/images/powerplus.png")
